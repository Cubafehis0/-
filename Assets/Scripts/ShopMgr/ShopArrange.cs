...
public static partial class ShopArrange
{
    ...
    //道具编号及其价格
    public static List<KeyValuePair<GoodsID, int>> GetShopGoods()
    {
        List<KeyValuePair<GoodsID, int>> valuePairs = new List<KeyValuePair<GoodsID, int>>();
        ...
        {
            valuePairs.Add(new KeyValuePair<GoodsID, int>((GoodsID)shopGoodsRandom[i], moneyRandom[i]));
        }
        return valuePairs;
    }
